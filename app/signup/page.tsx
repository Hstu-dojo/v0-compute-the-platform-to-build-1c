  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-[420px]">
        ...
        <p className="text-sm text-white/50 mb-8">Start studying smarter with PilotAI</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            <label className="block text-xs text-white/50 mb-1.5 font-mono">Display name</label>
            <input
              type="text"
              value={displayName}
